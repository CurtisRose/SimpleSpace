...
Shader "FORGE3D/Planets HD/Ice"
{
	Properties
	{
		...
		_TriplanarFalloff("Triplanar Falloff", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar11 = TriplanarSampling11( _HeightMap, packedInput.ase_texcoord5.xyz, packedInput.ase_normal, _TriplanarFalloff, _HeightTiling, 1.0, 0 );
				float4 height40 = triplanar11;
				float4 triplanar17 = TriplanarSampling17( _DetailMap, packedInput.ase_texcoord5.xyz, packedInput.ase_normal, _TriplanarFalloff, _DetailTiling, 1.0, 0 );
				...
				float temp_output_2_0_g46 = ( _IceFactorA - _IceDetail );
				float detaledHeightLinStep66 = saturate( saturate( ( ( detaledHeight61 - temp_output_2_0_g46 ) / ( ( _IceDetail + _IceFactorB ) - temp_output_2_0_g46 ) ) ) );
				float temp_output_6_0_g47 = ( detaledHeightLinStep66 / _IceFactorC );
				float3 lerpResult8_g47 = lerp( _RampLow.rgb , _RampMid.rgb , saturate( temp_output_6_0_g47 ));
				float3 lerpResult12_g47 = lerp( lerpResult8_g47 , _RampHigh.rgb , saturate( ( temp_output_6_0_g47 - 1.0 ) ));
				float4 triplanar34 = TriplanarSampling34( _ColorMap, packedInput.ase_texcoord5.xyz, packedInput.ase_normal, _TriplanarFalloff, _ColorTiling, 1.0, 0 );
				float4 colorMap42 = triplanar34;
				float4 detailedDepthColor78 = saturate( ( float4( lerpResult12_g47 , 0.0 ) * colorMap42 * _ColorBoost ) );
				...
				float4 triplanar5 = TriplanarSampling5( _NormalMap, packedInput.ase_texcoord5.xyz, packedInput.ase_normal, _TriplanarFalloff, _NormalTiling, 1.0, 0 );
				...
				float3 normalizeResult5_g48 = normalize( normalUnpacked30 );
				float dotResult14_g48 = dot( ase_tanViewDir , normalizeResult5_g48 );
				
				surfaceDescription.BaseColor = saturate( ( detailedDepthColor78 * saturate( ( float4( ( ( saturate( pow( max( 0.0 , saturate( ( 1.0 - dotResult14_g48 ) ) ) , _FresnelPower ) ) * _FrenselMult ) * (_FresnelColor).rgb ) , 0.0 ) + detailedDepthColor78 ) ) ) ).xyz;
				surfaceDescription.Normal = normalUnpacked30;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = saturate( ( _Specular * detailedDepthColor78 ) ).xyz;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = ( _Smoothness * ( 1.0 - detaledHeightLinStep66 ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar11 = TriplanarSampling11( _HeightMap, packedInput.ase_texcoord4.xyz, packedInput.ase_normal, _TriplanarFalloff, _HeightTiling, 1.0, 0 );
				float4 height40 = triplanar11;
				float4 triplanar17 = TriplanarSampling17( _DetailMap, packedInput.ase_texcoord4.xyz, packedInput.ase_normal, _TriplanarFalloff, _DetailTiling, 1.0, 0 );
				float4 detail41 = triplanar17;
				float4 break45 = detail41;
				float detailTexture50 = pow( ( break45.x * break45.y ) , 0.5 );
				float detaledHeight61 = ( height40.x + ( ( detailTexture50 - 0.5 ) * 2.0 * _IceDetail ) );
				...
				float3 lerpResult8_g47 = lerp( _RampLow.rgb , _RampMid.rgb , saturate( temp_output_6_0_g47 ));
				float3 lerpResult12_g47 = lerp( lerpResult8_g47 , _RampHigh.rgb , saturate( ( temp_output_6_0_g47 - 1.0 ) ));
				float4 triplanar34 = TriplanarSampling34( _ColorMap, packedInput.ase_texcoord4.xyz, packedInput.ase_normal, _TriplanarFalloff, _ColorTiling, 1.0, 0 );
				float4 colorMap42 = triplanar34;
				float4 detailedDepthColor78 = saturate( ( float4( lerpResult12_g47 , 0.0 ) * colorMap42 * _ColorBoost ) );
				...
				ase_tanViewDir = normalize(ase_tanViewDir);
				float4 triplanar5 = TriplanarSampling5( _NormalMap, packedInput.ase_texcoord4.xyz, packedInput.ase_normal, _TriplanarFalloff, _NormalTiling, 1.0, 0 );
				float3 unpack6 = UnpackNormalScale( triplanar5, _NormalScale );
				unpack6.z = lerp( 1, unpack6.z, saturate(_NormalScale) );
				float3 normalUnpacked30 = unpack6;
				float3 normalizeResult5_g48 = normalize( normalUnpacked30 );
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar5 = TriplanarSampling5( _NormalMap, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, _TriplanarFalloff, _NormalTiling, 1.0, 0 );
				float3 unpack6 = UnpackNormalScale( triplanar5, _NormalScale );
				unpack6.z = lerp( 1, unpack6.z, saturate(_NormalScale) );
				float3 normalUnpacked30 = unpack6;
				
				float4 triplanar11 = TriplanarSampling11( _HeightMap, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, _TriplanarFalloff, _HeightTiling, 1.0, 0 );
				float4 height40 = triplanar11;
				float4 triplanar17 = TriplanarSampling17( _DetailMap, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, _TriplanarFalloff, _DetailTiling, 1.0, 0 );
				float4 detail41 = triplanar17;
				float4 break45 = detail41;
				float detailTexture50 = pow( ( break45.x * break45.y ) , 0.5 );
				float detaledHeight61 = ( height40.x + ( ( detailTexture50 - 0.5 ) * 2.0 * _IceDetail ) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar11 = TriplanarSampling11( _HeightMap, packedInput.ase_texcoord7.xyz, packedInput.ase_normal, _TriplanarFalloff, _HeightTiling, 1.0, 0 );
				float4 height40 = triplanar11;
				float4 triplanar17 = TriplanarSampling17( _DetailMap, packedInput.ase_texcoord7.xyz, packedInput.ase_normal, _TriplanarFalloff, _DetailTiling, 1.0, 0 );
				float4 detail41 = triplanar17;
				float4 break45 = detail41;
				float detailTexture50 = pow( ( break45.x * break45.y ) , 0.5 );
				float detaledHeight61 = ( height40.x + ( ( detailTexture50 - 0.5 ) * 2.0 * _IceDetail ) );
				...
				float3 lerpResult8_g47 = lerp( _RampLow.rgb , _RampMid.rgb , saturate( temp_output_6_0_g47 ));
				float3 lerpResult12_g47 = lerp( lerpResult8_g47 , _RampHigh.rgb , saturate( ( temp_output_6_0_g47 - 1.0 ) ));
				float4 triplanar34 = TriplanarSampling34( _ColorMap, packedInput.ase_texcoord7.xyz, packedInput.ase_normal, _TriplanarFalloff, _ColorTiling, 1.0, 0 );
				float4 colorMap42 = triplanar34;
				float4 detailedDepthColor78 = saturate( ( float4( lerpResult12_g47 , 0.0 ) * colorMap42 * _ColorBoost ) );
				...
				float3 ase_tanViewDir =  tanToWorld0 * V.x + tanToWorld1 * V.y  + tanToWorld2 * V.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float4 triplanar5 = TriplanarSampling5( _NormalMap, packedInput.ase_texcoord7.xyz, packedInput.ase_normal, _TriplanarFalloff, _NormalTiling, 1.0, 0 );
				float3 unpack6 = UnpackNormalScale( triplanar5, _NormalScale );
				unpack6.z = lerp( 1, unpack6.z, saturate(_NormalScale) );
				float3 normalUnpacked30 = unpack6;
				float3 normalizeResult5_g48 = normalize( normalUnpacked30 );
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.RangedFloatNode;19;-1324.853,738.1995;Float;False;Property;_DetailTiling;Detail Tiling;10;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-1320.261,-26.69205;Float;False;Property;_HeightTiling;Height Tiling;11;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;790.9855,1092.539;Float;False;Property;_IceDetail;Ice Detail;17;0;Create;True;0;0;0;False;0;False;0;-1.67;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TriplanarNode;17;-1055.909,547.7406;Inherit;True;Spherical;Object;False;Top Texture 1;_TopTexture1;white;0;None;Mid Texture 1;_MidTexture1;white;0;None;Bot Texture 1;_BotTexture1;white;1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;291;-1735.056,359.5181;Inherit;False;Property;_TriplanarFalloff;Triplanar Falloff;22;0;Create;True;0;0;0;False;0;False;0;18.78;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;18;-1324.312,545.6213;Float;True;Property;_DetailMap;Detail Map;6;0;Create;True;0;0;0;False;0;False;None;c335803aac9ef704d8736e8b70606b49;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;10;-1350.685,-253.6016;Float;True;Property;_HeightMap;Height Map;7;0;Create;True;0;0;0;False;0;False;None;0b328f8ae2e6675459dec0dc0b62a260;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;66;2035.415,862.2281;Float;False;detaledHeightLinStep;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;48;672.868,736.1003;Inherit;False;40;height;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-1316.279,1077.637;Float;False;Property;_ColorTiling;Color Tiling;9;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;288;1871.337,859.4534;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;68;1650.055,855.0765;Inherit;False;Linstep;-1;;46;aade3b0317e32b148b41ee41b85032e6;0;3;4;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;789.1541,1285.331;Float;False;Property;_IceFactorB;Ice Factor B;15;0;Create;True;0;0;0;False;0;False;0;-0.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;778.3278,1184.858;Float;False;Property;_IceFactorA;Ice Factor A;14;0;Create;True;0;0;0;False;0;False;0;1.84;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;73;1661.411,1454.327;Float;False;Property;_RampHigh;RampHigh;18;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2632164,0.5271441,0.6132076,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;71;1661.411,1111.327;Float;False;Property;_RampLow;RampLow;20;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6650944,0.9317183,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;78;2647.9,850.5322;Float;False;detailedDepthColor;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SaturateNode;255;2458.488,1258.108;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1293.599,359.1625;Float;False;Property;_NormalTiling;Normal Tiling;12;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.UnpackScaleNormalNode;6;-611.6559,286.8498;Inherit;False;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-891.3169,354.9139;Float;False;Property;_NormalScale;Normal Scale;13;0;Create;True;0;0;0;False;0;False;0;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;254;2069.488,1522.108;Float;False;Property;_ColorBoost;Color Boost;0;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;77;2047.231,1437.75;Inherit;False;42;colorMap;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TriplanarNode;5;-1069.881,150.9297;Inherit;True;Spherical;Object;False;Top Texture 3;_TopTexture3;white;0;None;Mid Texture 3;_MidTexture3;white;0;None;Bot Texture 3;_BotTexture3;white;1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;70;1691.128,1618.006;Float;False;Property;_IceFactorC;Ice Factor C;16;0;Create;True;0;0;0;False;0;False;0;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;72;1661.411,1281.327;Float;False;Property;_RampMid;RampMid;19;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4962173,0.5509833,0.5943396,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1330.088,147.3217;Float;True;Property;_NormalMap;Normal Map;8;0;Create;True;0;0;0;False;0;False;None;4610b58d5667c8b488023068867fe203;True;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;69;2018.528,1258.346;Inherit;False;Ramp3;-1;;47;d38b6eed89401a040a9f914ae79b3d2f;0;5;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;5;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;62;1610.036,-168.7173;Inherit;False;78;detailedDepthColor;1;0;OBJECT;;False;1;FLOAT4;0
...
WireConnection;296;0;252;0
WireConnection;250;22;251;0
WireConnection;252;0;250;0
WireConnection;252;1;62;0
WireConnection;299;0;298;0
WireConnection;292;0;83;0
WireConnection;292;1;294;0
WireConnection;297;0;81;0
WireConnection;294;0;66;0
WireConnection;298;0;82;0
WireConnection;298;1;78;0
WireConnection;81;0;78;0
WireConnection;81;1;296;0
WireConnection;324;0;297;0
WireConnection;324;1;31;0
WireConnection;324;5;299;0
WireConnection;324;7;292;0
ASEEND*/
//CHKSM=CA9A94B7B88704DA05BCB97CC1D50D736BABD66B