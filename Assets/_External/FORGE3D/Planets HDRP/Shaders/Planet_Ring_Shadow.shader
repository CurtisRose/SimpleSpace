	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float temp_output_14_0 = ( _RingOffset + 1.0 );
				float4 appendResult18 = (float4(( ( length( packedInput.ase_texcoord.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
				float4 tex2DNode1 = tex2D( _DetailMap, appendResult18.xy );
				float temp_output_121_0 = saturate( ( tex2DNode1.a * _Clip ) );
...
ASEEND*/
//CHKSM=C2F5D8BD54EF26DD34D4A37FE65E4825A1646216