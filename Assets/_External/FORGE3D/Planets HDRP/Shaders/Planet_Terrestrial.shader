...
Shader "FORGE3D/Planets HD/Terrestrial"
{
	Properties
	{
		...
		_WaterShoreStep("WaterShore Step", Vector) = (0.48,0.73,0,0)
		...
		_CloudOcclusion("Cloud Occlusion", Range( 0 , 1)) = 0.03
		_CloudShadows("Cloud Shadows", Range( 0 , 1)) = 0.03
		[ASEEnd]_CloudsOutput("Clouds Output", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 GetLightData375(  )
			{
				if(_DirectionalLightCount > 0)
				return 0;
				LightData mainLight = _LightDatas[0];
				return mainLight.positionRWS.xyz;
			}
			
			float2 rotateUV1_g448( float time, float2 uv, float speed )
			{
						...
						)
			{
				...
				float3 temp_output_1_0_g456 = packedInput.ase_normal;
				float3 localGetLightData375 = GetLightData375();
				float3 normalizeResult7_g455 = normalize( ( -_DirectionalLightDatas[0].forward + localGetLightData375 ) );
				float dotResult4_g456 = dot( temp_output_1_0_g456 , normalizeResult7_g455 );
				float3 normalizeResult8_g455 = normalize( V );
				float dotResult7_g456 = dot( temp_output_1_0_g456 , normalizeResult8_g455 );
				float2 appendResult10_g456 = (float2(( ( dotResult4_g456 / 2.0 ) + 0.5 ) , dotResult7_g456));
				float4 temp_output_372_0 = saturate( ( ( ( tex2D( _ScatterMap, ( ( _ScatterCenterShift + appendResult10_g456 ) * _ScatterStretch ) ) * _ScatterColor ) * _ScatterBoost ) + _ScatterIndirect ) );
				float time1_g448 = _TimeParameters.x;
				float2 uv2_CloudsTop = packedInput.uv1.xy * _CloudsTop_ST.xy + _CloudsTop_ST.zw;
				float2 uv1_g448 = uv2_CloudsTop;
				float speed1_g448 = _CloudsTopSpeed;
				float2 localrotateUV1_g448 = rotateUV1_g448( time1_g448 , uv1_g448 , speed1_g448 );
				float2 poleUV63_g447 = localrotateUV1_g448;
				float cloudPole76_g447 = tex2D( _CloudsTop, poleUV63_g447 ).r;
				float2 uv_CloudsMiddle = packedInput.ase_texcoord5.xy * _CloudsMiddle_ST.xy + _CloudsMiddle_ST.zw;
				float2 break53_g447 = uv_CloudsMiddle;
				float2 appendResult55_g447 = (float2(( break53_g447.x + ( _CloudsMiddleSpeed * _TimeParameters.x ) ) , break53_g447.y));
				float2 bellyUV56_g447 = appendResult55_g447;
				float cloudBelly73_g447 = tex2D( _CloudsMiddle, bellyUV56_g447 ).r;
				float2 uv_Gradient = packedInput.ase_texcoord5.xy * _Gradient_ST.xy + _Gradient_ST.zw;
				float gradientMap93_g447 = pow( max( tex2D( _Gradient, uv_Gradient ).r , 0.0 ) , _CloudsBlendWeight );
				float lerpResult25_g447 = lerp( cloudPole76_g447 , cloudBelly73_g447 , gradientMap93_g447);
				float cloudMix80_g447 = lerpResult25_g447;
				float4 temp_output_388_0 = saturate( ( cloudMix80_g447 * _CloudsTint * _CloudsOutput ) );
				float3 normalizeResult126_g447 = normalize( -_DirectionalLightDatas[0].forward );
				float2 shadowUVPole47_g447 = (( _CloudsHeight * normalizeResult126_g447 )).xx;
				float cloudPoleShadow94_g447 = tex2D( _CloudsTop, ( poleUV63_g447 + shadowUVPole47_g447 ) ).r;
				...
				float3 normalizeResult36_g447 = normalize( mul( ase_worldToTangent, -_DirectionalLightDatas[0].forward ) );
				float2 shadowUVBelly46_g447 = (( normalizeResult36_g447 * _CloudsHeight )).xx;
				float cloudBellyShadow85_g447 = tex2D( _CloudsMiddle, ( shadowUVBelly46_g447 + bellyUV56_g447 ) ).r;
				float lerpResult95_g447 = lerp( cloudPoleShadow94_g447 , cloudBellyShadow85_g447 , ( gradientMap93_g447 + 0.1 ));
				float temp_output_132_0_g447 = max( 0.0 , ( 1.0 - lerpResult95_g447 ) );
				float cloudMixShadow99_g447 = saturate( pow( temp_output_132_0_g447 , ( _CloudShadows * 50.0 ) ) );
				float temp_output_388_122 = cloudMixShadow99_g447;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar5 = TriplanarSampling5( _HeightMap, packedInput.ase_texcoord7.xyz, packedInput.ase_normal, 5.0, _HeightTiling, 1.0, 0 );
				float4 height6 = triplanar5;
				float4 break16 = height6;
				float temp_output_10_0_g449 = break16.z;
				float lerpResult16_g449 = lerp( 0.0 , 1.0 , ( ( _DesertCoverage - ( break16.x * temp_output_10_0_g449 ) ) * _DesertFactors ));
				float4 lerpResult19_g449 = lerp( float4( ( _BaseColor * height6.x ).rgb , 0.0 ) , ( _DesertColor * temp_output_10_0_g449 ) , saturate( lerpResult16_g449 ));
				float lerpResult16_g446 = lerp( 0.0 , 1.0 , ( ( _VegetationCoverage - ( break16.x * break16.z ) ) * _VegetationFactors ));
				float4 lerpResult19_g446 = lerp( float4( saturate( lerpResult19_g449 ).rgb , 0.0 ) , ( _VegetationColor * break16.y ) , saturate( lerpResult16_g446 ));
				float lerpResult16_g453 = lerp( 0.0 , 1.0 , ( ( _MountainCoverage - break16.z ) * _MountainFactors ));
				float4 lerpResult19_g453 = lerp( float4( saturate( lerpResult19_g446 ).rgb , 0.0 ) , ( break16.x * _MountainColor ) , saturate( lerpResult16_g453 ));
				float4 temp_output_15_0 = saturate( lerpResult19_g453 );
				float4 break22 = height6;
				float depth11_g457 = saturate( ( pow( max( 0.0 , ( break22.x * break22.z ) ) , _WaterDetailFactor ) * _WaterDetailBoost ) );
				float4 lerpResult19_g457 = lerp( _WaterDeepColor , _WaterShallowColor , depth11_g457);
				float2 uv_LandMask = packedInput.ase_texcoord5.xy * _LandMask_ST.xy + _LandMask_ST.zw;
				float4 tex2DNode2 = tex2D( _LandMask, uv_LandMask );
				float shoreMask16_g457 = saturate( pow( max( 0.0 , saturate( ( 1.0 - saturate( step( tex2DNode2.g , _WaterShoreStep.y ) ) ) ) ) , _WaterShoreFactor ) );
				float4 lerpResult23_g457 = lerp( ( _WaterShoreColor + lerpResult19_g457 ) , lerpResult19_g457 , shoreMask16_g457);
				float4 waterColor25_g457 = lerpResult23_g457;
				float temp_output_377_0 = step( tex2DNode2.r , _WaterShoreStep.x );
				float4 lerpResult27_g457 = lerp( float4( temp_output_15_0.rgb , 0.0 ) , waterColor25_g457 , temp_output_377_0);
				...
				float4 triplanar51 = TriplanarSampling51( _NormalMap, packedInput.ase_texcoord7.xyz, packedInput.ase_normal, 5.0, _NormalTiling, 1.0, 0 );
				...
				float3 lerpResult80 = lerp( fresnelNormalUnpacked73 , normalUnpacked54 , temp_output_377_0);
				float3 normalizeResult5_g452 = normalize( lerpResult80 );
				float dotResult14_g452 = dot( ase_tanViewDir , normalizeResult5_g452 );
				float temp_output_37_0_g452 = max( 0.0 , saturate( ( 1.0 - dotResult14_g452 ) ) );
				float4 lerpResult32_g452 = lerp( ( ( saturate( pow( temp_output_37_0_g452 , _FresnelLandPower ) ) * _FrenselLandMult ) * _FresnelLandColor ) , ( ( saturate( pow( temp_output_37_0_g452 , _FresnelWaterPower ) ) * _FresnelWaterMult ) * _FresnelWaterColor ) , temp_output_377_0);
				float4 alb310 = ( temp_output_372_0 * ( temp_output_388_0 + ( temp_output_388_122 * saturate( ( saturate( ( _GlobalBoost * lerpResult27_g457 ) ) + saturate( lerpResult32_g452 ) ) ) ) ) );
				
				float4 normalizeResult60 = normalize( float4(0,0,1,0) );
				float4 lerpResult66 = lerp( float4( normalUnpacked54 , 0.0 ) , normalizeResult60 , temp_output_377_0);
				float4 lerpResult192 = lerp( lerpResult66 , float4(0,0,1,0) , ( 1.0 - temp_output_388_122 ));
				float4 normalizeResult220 = normalize( lerpResult192 );
				float4 normal307 = normalizeResult220;
				float4 lerpResult361 = lerp( normal307 , float4(0,0,1,0) , temp_output_388_0.r);
				
				float4 lerpResult47 = lerp( ( temp_output_15_0 * _LandSpecular ) , saturate( ( _WaterSpecular * ( depth11_g457 + 0.1 ) * _WaterSpecularColor ) ) , temp_output_377_0);
				float4 spec308 = lerpResult47;
				float temp_output_388_137 = saturate( pow( temp_output_132_0_g447 , ( _CloudOcclusion * 50.0 ) ) );
				
				float2 uv_CityLightMaskMap = packedInput.ase_texcoord5.xy * _CityLightMaskMap_ST.xy + _CityLightMaskMap_ST.zw;
				float mask19_g450 = tex2D( _CityLightMaskMap, uv_CityLightMaskMap ).r;
				float2 uv_CityLightUVMap = packedInput.ase_texcoord5.xy * _CityLightUVMap_ST.xy + _CityLightUVMap_ST.zw;
				float4 tex2DNode12_g450 = tex2D( _CityLightUVMap, uv_CityLightUVMap );
				float2 appendResult20_g450 = (float2(tex2DNode12_g450.r , tex2DNode12_g450.g));
				float2 detailUV21_g450 = appendResult20_g450;
				float cityLightMap24_g450 = ( mask19_g450 * tex2D( _CityLightMap, detailUV21_g450 ).r );
				float4 emiss309 = ( ( 1.0 - temp_output_372_0.r ) * ( temp_output_388_122 * ( _CityLightColor * pow( max( 0.0 , cityLightMap24_g450 ) , ( 1.0 / _CityLightPopulation ) ) * ( 1.0 - ( 1.0 - tex2DNode2.r ) ) ) ) );
				
				float lerpResult48 = lerp( ( _LandSmoothness * ( break16.x + break16.y + break16.z ) ) , _WaterSmoothness , temp_output_377_0);
				float temp_output_95_0 = saturate( lerpResult48 );
				float smooth306 = temp_output_95_0;
				
				surfaceDescription.BaseColor = alb310.rgb;
				surfaceDescription.Normal = lerpResult361.xyz;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( spec308 * temp_output_388_137 ).rgb;
				#endif

				surfaceDescription.Emission = emiss309.rgb;
				surfaceDescription.Smoothness = smooth306;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.zw = inputMesh.uv0.xy;
				outputPackedVaryingsMeshToPS.ase_texcoord7 = float4(inputMesh.positionOS,1);
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 normalizeResult8_g455 = normalize( ase_worldViewDir );
				float dotResult7_g456 = dot( temp_output_1_0_g456 , normalizeResult8_g455 );
				float2 appendResult10_g456 = (float2(( ( dotResult4_g456 / 2.0 ) + 0.5 ) , dotResult7_g456));
				float4 temp_output_372_0 = saturate( ( ( ( tex2D( _ScatterMap, ( ( _ScatterCenterShift + appendResult10_g456 ) * _ScatterStretch ) ) * _ScatterColor ) * _ScatterBoost ) + _ScatterIndirect ) );
				float time1_g448 = _TimeParameters.x;
				float2 uv2_CloudsTop = packedInput.ase_texcoord3.xy * _CloudsTop_ST.xy + _CloudsTop_ST.zw;
				float2 uv1_g448 = uv2_CloudsTop;
				float speed1_g448 = _CloudsTopSpeed;
				float2 localrotateUV1_g448 = rotateUV1_g448( time1_g448 , uv1_g448 , speed1_g448 );
				float2 poleUV63_g447 = localrotateUV1_g448;
				float cloudPole76_g447 = tex2D( _CloudsTop, poleUV63_g447 ).r;
				float2 uv_CloudsMiddle = packedInput.ase_texcoord3.zw * _CloudsMiddle_ST.xy + _CloudsMiddle_ST.zw;
				float2 break53_g447 = uv_CloudsMiddle;
				float2 appendResult55_g447 = (float2(( break53_g447.x + ( _CloudsMiddleSpeed * _TimeParameters.x ) ) , break53_g447.y));
				float2 bellyUV56_g447 = appendResult55_g447;
				float cloudBelly73_g447 = tex2D( _CloudsMiddle, bellyUV56_g447 ).r;
				float2 uv_Gradient = packedInput.ase_texcoord3.zw * _Gradient_ST.xy + _Gradient_ST.zw;
				float gradientMap93_g447 = pow( max( tex2D( _Gradient, uv_Gradient ).r , 0.0 ) , _CloudsBlendWeight );
				float lerpResult25_g447 = lerp( cloudPole76_g447 , cloudBelly73_g447 , gradientMap93_g447);
				float cloudMix80_g447 = lerpResult25_g447;
				float4 temp_output_388_0 = saturate( ( cloudMix80_g447 * _CloudsTint * _CloudsOutput ) );
				...
				float depth11_g457 = saturate( ( pow( max( 0.0 , ( break22.x * break22.z ) ) , _WaterDetailFactor ) * _WaterDetailBoost ) );
				float4 lerpResult19_g457 = lerp( _WaterDeepColor , _WaterShallowColor , depth11_g457);
				float2 uv_LandMask = packedInput.ase_texcoord3.zw * _LandMask_ST.xy + _LandMask_ST.zw;
				float4 tex2DNode2 = tex2D( _LandMask, uv_LandMask );
				float shoreMask16_g457 = saturate( pow( max( 0.0 , saturate( ( 1.0 - saturate( step( tex2DNode2.g , _WaterShoreStep.y ) ) ) ) ) , _WaterShoreFactor ) );
				float4 lerpResult23_g457 = lerp( ( _WaterShoreColor + lerpResult19_g457 ) , lerpResult19_g457 , shoreMask16_g457);
				float4 waterColor25_g457 = lerpResult23_g457;
				...
				float2 uv_CityLightMaskMap = packedInput.ase_texcoord3.zw * _CityLightMaskMap_ST.xy + _CityLightMaskMap_ST.zw;
				float mask19_g450 = tex2D( _CityLightMaskMap, uv_CityLightMaskMap ).r;
				float2 uv_CityLightUVMap = packedInput.ase_texcoord3.zw * _CityLightUVMap_ST.xy + _CityLightUVMap_ST.zw;
				float4 tex2DNode12_g450 = tex2D( _CityLightUVMap, uv_CityLightUVMap );
				float2 appendResult20_g450 = (float2(tex2DNode12_g450.r , tex2DNode12_g450.g));
				float2 detailUV21_g450 = appendResult20_g450;
				float cityLightMap24_g450 = ( mask19_g450 * tex2D( _CityLightMap, detailUV21_g450 ).r );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.zw = inputMesh.ase_texcoord1.xy;
					...
					)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar51 = TriplanarSampling51( _NormalMap, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, 5.0, _NormalTiling, 1.0, 0 );
				float3 unpack52 = UnpackNormalScale( triplanar51, _NormalScale );
				unpack52.z = lerp( 1, unpack52.z, saturate(_NormalScale) );
				float3 normalUnpacked54 = unpack52;
				float4 normalizeResult60 = normalize( float4(0,0,1,0) );
				float2 uv_LandMask = packedInput.ase_texcoord4.xy * _LandMask_ST.xy + _LandMask_ST.zw;
				float4 tex2DNode2 = tex2D( _LandMask, uv_LandMask );
				float temp_output_377_0 = step( tex2DNode2.r , _WaterShoreStep.x );
				float4 lerpResult66 = lerp( float4( normalUnpacked54 , 0.0 ) , normalizeResult60 , temp_output_377_0);
				float time1_g448 = _TimeParameters.x;
				float2 uv2_CloudsTop = packedInput.ase_texcoord4.zw * _CloudsTop_ST.xy + _CloudsTop_ST.zw;
				float2 uv1_g448 = uv2_CloudsTop;
				float speed1_g448 = _CloudsTopSpeed;
				float2 localrotateUV1_g448 = rotateUV1_g448( time1_g448 , uv1_g448 , speed1_g448 );
				float2 poleUV63_g447 = localrotateUV1_g448;
				...
				float3 normalizeResult36_g447 = normalize( mul( ase_worldToTangent, -_DirectionalLightDatas[0].forward ) );
				float2 shadowUVBelly46_g447 = (( normalizeResult36_g447 * _CloudsHeight )).xx;
				float2 uv_CloudsMiddle = packedInput.ase_texcoord4.xy * _CloudsMiddle_ST.xy + _CloudsMiddle_ST.zw;
				float2 break53_g447 = uv_CloudsMiddle;
				float2 appendResult55_g447 = (float2(( break53_g447.x + ( _CloudsMiddleSpeed * _TimeParameters.x ) ) , break53_g447.y));
				float2 bellyUV56_g447 = appendResult55_g447;
				float cloudBellyShadow85_g447 = tex2D( _CloudsMiddle, ( shadowUVBelly46_g447 + bellyUV56_g447 ) ).r;
				float2 uv_Gradient = packedInput.ase_texcoord4.xy * _Gradient_ST.xy + _Gradient_ST.zw;
				float gradientMap93_g447 = pow( max( tex2D( _Gradient, uv_Gradient ).r , 0.0 ) , _CloudsBlendWeight );
				float lerpResult95_g447 = lerp( cloudPoleShadow94_g447 , cloudBellyShadow85_g447 , ( gradientMap93_g447 + 0.1 ));
				float temp_output_132_0_g447 = max( 0.0 , ( 1.0 - lerpResult95_g447 ) );
				float cloudMixShadow99_g447 = saturate( pow( temp_output_132_0_g447 , ( _CloudShadows * 50.0 ) ) );
				...
				float4 triplanar5 = TriplanarSampling5( _HeightMap, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, 5.0, _HeightTiling, 1.0, 0 );
				float4 height6 = triplanar5;
				float4 break16 = height6;
				float lerpResult48 = lerp( ( _LandSmoothness * ( break16.x + break16.y + break16.z ) ) , _WaterSmoothness , temp_output_377_0);
				float temp_output_95_0 = saturate( lerpResult48 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.zw = inputMesh.ase_texcoord1.xy;
				...
				)
			{
				...
				float4 triplanar51 = TriplanarSampling51( _NormalMap, packedInput.ase_texcoord5.xyz, packedInput.ase_normal, 5.0, _NormalTiling, 1.0, 0 );
				float3 unpack52 = UnpackNormalScale( triplanar51, _NormalScale );
				unpack52.z = lerp( 1, unpack52.z, saturate(_NormalScale) );
				float3 normalUnpacked54 = unpack52;
				float4 normalizeResult60 = normalize( float4(0,0,1,0) );
				float2 uv_LandMask = packedInput.ase_texcoord6.xy * _LandMask_ST.xy + _LandMask_ST.zw;
				float4 tex2DNode2 = tex2D( _LandMask, uv_LandMask );
				float temp_output_377_0 = step( tex2DNode2.r , _WaterShoreStep.x );
				float4 lerpResult66 = lerp( float4( normalUnpacked54 , 0.0 ) , normalizeResult60 , temp_output_377_0);
				float time1_g448 = _TimeParameters.x;
				float2 uv2_CloudsTop = packedInput.ase_texcoord6.zw * _CloudsTop_ST.xy + _CloudsTop_ST.zw;
				float2 uv1_g448 = uv2_CloudsTop;
				float speed1_g448 = _CloudsTopSpeed;
				float2 localrotateUV1_g448 = rotateUV1_g448( time1_g448 , uv1_g448 , speed1_g448 );
				float2 poleUV63_g447 = localrotateUV1_g448;
				...
				float3 normalizeResult36_g447 = normalize( mul( ase_worldToTangent, -_DirectionalLightDatas[0].forward ) );
				float2 shadowUVBelly46_g447 = (( normalizeResult36_g447 * _CloudsHeight )).xx;
				float2 uv_CloudsMiddle = packedInput.ase_texcoord6.xy * _CloudsMiddle_ST.xy + _CloudsMiddle_ST.zw;
				float2 break53_g447 = uv_CloudsMiddle;
				float2 appendResult55_g447 = (float2(( break53_g447.x + ( _CloudsMiddleSpeed * _TimeParameters.x ) ) , break53_g447.y));
				float2 bellyUV56_g447 = appendResult55_g447;
				float cloudBellyShadow85_g447 = tex2D( _CloudsMiddle, ( shadowUVBelly46_g447 + bellyUV56_g447 ) ).r;
				float2 uv_Gradient = packedInput.ase_texcoord6.xy * _Gradient_ST.xy + _Gradient_ST.zw;
				float gradientMap93_g447 = pow( max( tex2D( _Gradient, uv_Gradient ).r , 0.0 ) , _CloudsBlendWeight );
				float lerpResult95_g447 = lerp( cloudPoleShadow94_g447 , cloudBellyShadow85_g447 , ( gradientMap93_g447 + 0.1 ));
				float temp_output_132_0_g447 = max( 0.0 , ( 1.0 - lerpResult95_g447 ) );
				float cloudMixShadow99_g447 = saturate( pow( temp_output_132_0_g447 , ( _CloudShadows * 50.0 ) ) );
				...
				float4 triplanar5 = TriplanarSampling5( _HeightMap, packedInput.ase_texcoord5.xyz, packedInput.ase_normal, 5.0, _HeightTiling, 1.0, 0 );
				float4 height6 = triplanar5;
				float4 break16 = height6;
				float lerpResult48 = lerp( ( _LandSmoothness * ( break16.x + break16.y + break16.z ) ) , _WaterSmoothness , temp_output_377_0);
				float temp_output_95_0 = saturate( lerpResult48 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 poleUV63_g447 = localrotateUV1_g448;
				float cloudPole76_g447 = tex2D( _CloudsTop, poleUV63_g447 ).r;
				float2 uv_CloudsMiddle = packedInput.ase_texcoord7.xy * _CloudsMiddle_ST.xy + _CloudsMiddle_ST.zw;
				float2 break53_g447 = uv_CloudsMiddle;
				float2 appendResult55_g447 = (float2(( break53_g447.x + ( _CloudsMiddleSpeed * _TimeParameters.x ) ) , break53_g447.y));
				float2 bellyUV56_g447 = appendResult55_g447;
				float cloudBelly73_g447 = tex2D( _CloudsMiddle, bellyUV56_g447 ).r;
				...
				float temp_output_388_122 = cloudMixShadow99_g447;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar5 = TriplanarSampling5( _HeightMap, packedInput.ase_texcoord9.xyz, packedInput.ase_normal, 5.0, _HeightTiling, 1.0, 0 );
				float4 height6 = triplanar5;
				float4 break16 = height6;
				float temp_output_10_0_g449 = break16.z;
				float lerpResult16_g449 = lerp( 0.0 , 1.0 , ( ( _DesertCoverage - ( break16.x * temp_output_10_0_g449 ) ) * _DesertFactors ));
				...
				float depth11_g457 = saturate( ( pow( max( 0.0 , ( break22.x * break22.z ) ) , _WaterDetailFactor ) * _WaterDetailBoost ) );
				float4 lerpResult19_g457 = lerp( _WaterDeepColor , _WaterShallowColor , depth11_g457);
				float2 uv_LandMask = packedInput.ase_texcoord7.xy * _LandMask_ST.xy + _LandMask_ST.zw;
				float4 tex2DNode2 = tex2D( _LandMask, uv_LandMask );
				float shoreMask16_g457 = saturate( pow( max( 0.0 , saturate( ( 1.0 - saturate( step( tex2DNode2.g , _WaterShoreStep.y ) ) ) ) ) , _WaterShoreFactor ) );
				float4 lerpResult23_g457 = lerp( ( _WaterShoreColor + lerpResult19_g457 ) , lerpResult19_g457 , shoreMask16_g457);
				float4 waterColor25_g457 = lerpResult23_g457;
				...
				float3 ase_tanViewDir =  tanToWorld0 * V.x + tanToWorld1 * V.y  + tanToWorld2 * V.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float4 triplanar51 = TriplanarSampling51( _NormalMap, packedInput.ase_texcoord9.xyz, packedInput.ase_normal, 5.0, _NormalTiling, 1.0, 0 );
				float3 unpack71 = UnpackNormalScale( triplanar51, _NormalFresnelScale );
				unpack71.z = lerp( 1, unpack71.z, saturate(_NormalFresnelScale) );
				float3 fresnelNormalUnpacked73 = unpack71;
				float3 unpack52 = UnpackNormalScale( triplanar51, _NormalScale );
				...
				float2 uv_CityLightMaskMap = packedInput.ase_texcoord7.xy * _CityLightMaskMap_ST.xy + _CityLightMaskMap_ST.zw;
				float mask19_g450 = tex2D( _CityLightMaskMap, uv_CityLightMaskMap ).r;
				float2 uv_CityLightUVMap = packedInput.ase_texcoord7.xy * _CityLightUVMap_ST.xy + _CityLightUVMap_ST.zw;
				float4 tex2DNode12_g450 = tex2D( _CityLightUVMap, uv_CityLightUVMap );
				float2 appendResult20_g450 = (float2(tex2DNode12_g450.r , tex2DNode12_g450.g));
				float2 detailUV21_g450 = appendResult20_g450;
				float cityLightMap24_g450 = ( mask19_g450 * tex2D( _CityLightMap, detailUV21_g450 ).r );
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.RangedFloatNode;4;-1576.536,-178.1983;Float;False;Property;_HeightTiling;Height Tiling;39;0;Create;True;0;0;0;False;0;False;0;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;307;3833.057,-589.6783;Inherit;False;normal;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.Vector4Node;362;3649.807,-1344.75;Inherit;False;Constant;_Vector1;Vector 1;21;0;Create;True;0;0;0;False;0;False;0,0,1,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;139;3015.954,-868.0078;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;347;3275.885,-1109.875;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;385;538.8867,-881.8914;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;227.1252,145.1049;Float;False;Property;_LandSmoothness;Land Smoothness;33;0;Create;True;0;0;0;False;0;False;0.03;0.486;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;13;-51.60282,-171.6952;Inherit;False;VegetationColor;47;;446;7b054f74514e3c545b05ee9d3cc768b8;0;4;23;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;False;6;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;308;2799.804,-455.9715;Inherit;False;spec;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;2;123.6483,-356.9921;Inherit;True;Property;_LandMask;Land Mask;40;0;Create;True;0;0;0;False;0;False;-1;None;1744fab73973e9347836cd337c5a59d6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;196;3067.096,-605.9888;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1584.791,-395.6999;Float;True;Property;_HeightMap;Height Map;38;0;Create;True;0;0;0;False;0;False;None;a01e51192e20ad542bf77849171a65d9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.StepOpNode;381;435.7033,-608.548;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;49;-1585.307,65.96893;Float;True;Property;_NormalMap;Normal Map;34;1;[Normal];Create;True;0;0;0;False;0;False;None;3c13bc84830f236458594e2f6cc9c04a;True;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector3Node;380;29.09451,-778.9958;Inherit;False;Property;_WaterShoreStep;WaterShore Step;21;0;Create;True;0;0;0;False;0;False;0.48,0.73,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;232;2549.677,-678.0405;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NormalizeNode;60;946.5662,333.408;Inherit;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;388;1607.697,-912.4413;Inherit;False;Clouds;55;;447;b41fa152b94c44b4e9f91f67316d221d;0;1;127;FLOAT4;0,0,0,0;False;3;FLOAT;122;FLOAT;137;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;185;2800.776,-286.6036;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;376;2359.722,-1152.082;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;289;1925.538,-414.879;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;44;227.1252,48.10492;Float;False;Property;_LandSpecular;Land Specular;32;0;Create;True;0;0;0;False;0;False;0.03;0.766;0.03;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-1233.957,479.2798;Float;False;Property;_NormalFresnelScale;Normal Fresnel Scale;36;0;Create;True;0;0;0;False;0;False;0;0.63;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;384;884.4865,-800.3916;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;17;-375.2998,-241.896;Inherit;False;DesertColor;43;;449;1b595ba52fc886e48b4be4810312f928;0;3;3;FLOAT;0;False;10;FLOAT;0;False;6;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;345;3010.201,-1109.874;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.BreakToComponentsNode;360;3678.429,-1105.678;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.StepOpNode;377;419.8912,-735.807;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;327;2057.312,-473.4725;Inherit;False;CityLights;8;;450;4cc89f4a87600d74dbfda0723672d233;0;1;17;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;382;706.4865,-886.3916;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;363;1049.029,-256.8683;Inherit;False;FresnelLandWater;1;;452;3e95808d42a13c34980842be780f16a4;0;2;24;FLOAT;0;False;22;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-1237.554,391.696;Float;False;Property;_NormalScale;Normal Scale;37;0;Create;True;0;0;0;False;0;False;0;0.08;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;346;3490.818,-836.73;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;383;307.4865,-877.3916;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;375;2064.722,-1128.082;Inherit;False;if(_DirectionalLightCount > 0)$return 0@$LightData mainLight = _LightDatas[0]@$return mainLight.positionRWS.xyz@$$$;3;Create;0;GetLightData;True;False;0;;False;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-1577.052,283.4705;Float;False;Property;_NormalTiling;Normal Tiling;35;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;15;240.8973,-79.39526;Inherit;False;MountainColor;51;;453;4181dbe52ccd82c468b472a633e7f96c;0;3;3;FLOAT;0;False;10;FLOAT;0;False;6;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;190;2500.516,7.750409;Inherit;False;Property;_CloudsSmoothnessLerp;Clouds Smoothness  Lerp;67;0;Create;True;0;0;0;False;0;False;0;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;23;70.30082,-489.5881;Inherit;False;6;height;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.OneMinusNode;389;1377.758,-608.6506;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;373;2032.722,-1348.082;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;1;-677.4996,-290.1661;Inherit;False;BaseColor;41;;454;436e5fd3b4e5f564d91908d8a8c53f20;0;1;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;293;0;388;122
WireConnection;293;1;76;0
WireConnection;54;0;52;0
WireConnection;308;0;47;0
WireConnection;66;0;55;0
WireConnection;66;1;60;0
WireConnection;66;2;377;0
WireConnection;196;0;388;122
WireConnection;381;0;2;2
WireConnection;381;1;380;2
WireConnection;5;0;3;0
WireConnection;5;3;4;0
WireConnection;67;0;45;0
WireConnection;67;1;68;0
WireConnection;232;0;388;122
...
WireConnection;345;0;372;0
WireConnection;70;0;127;0
WireConnection;70;1;363;0
WireConnection;360;0;388;0
WireConnection;377;0;2;1
WireConnection;377;1;380;1
WireConnection;292;0;388;0
WireConnection;292;1;293;0
WireConnection;327;17;389;0
WireConnection;382;0;385;0
WireConnection;363;24;377;0
WireConnection;363;22;80;0
WireConnection;16;0;6;0
WireConnection;220;0;192;0
WireConnection;346;0;347;0
WireConnection;346;1;232;0
WireConnection;383;0;2;1
WireConnection;48;0;67;0
WireConnection;48;1;301;35
WireConnection;48;2;377;0
...
WireConnection;389;0;2;1
WireConnection;1;1;6;0
WireConnection;52;0;51;0
WireConnection;52;1;53;0
WireConnection;80;0;81;0
WireConnection;80;1;55;0
WireConnection;80;2;377;0
WireConnection;372;31;376;0
WireConnection;301;4;22;0
WireConnection;301;3;22;2
WireConnection;301;26;377;0
WireConnection;301;12;384;0
WireConnection;301;1;15;0
WireConnection;310;0;139;0
WireConnection;361;0;307;0
WireConnection;361;1;362;0
WireConnection;361;2;360;0
WireConnection;309;0;346;0
WireConnection;230;0;308;0
WireConnection;230;1;388;137
WireConnection;306;0;95;0
WireConnection;398;0;310;0
WireConnection;398;1;361;0
WireConnection;398;5;230;0
WireConnection;398;6;309;0
WireConnection;398;7;306;0
ASEEND*/
//CHKSM=23D6412A8C4446BAEB7723857EF5B6C7C38D418B