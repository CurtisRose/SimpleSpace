...
Shader "FORGE3D/Planets HD/Sand"
{
	Properties
	{
		...
		[ASEEnd]_CloudBoost("Cloud Boost", Float) = 5
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_output_1_0_g225 = packedInput.ase_normal;
				float3 normalizeResult7_g224 = normalize( float3( 0,0,0 ) );
				float dotResult4_g225 = dot( temp_output_1_0_g225 , normalizeResult7_g224 );
				float3 normalizeResult8_g224 = normalize( V );
				...
				float3 normalizeResult126_g222 = normalize( -_DirectionalLightDatas[0].forward );
				...
				float3 normalizeResult36_g222 = normalize( mul( ase_worldToTangent, -_DirectionalLightDatas[0].forward ) );
				...
				float temp_output_132_0_g222 = max( 0.0 , ( 1.0 - lerpResult95_g222 ) );
				float cloudMixShadow99_g222 = saturate( pow( temp_output_132_0_g222 , ( _CloudShadows * 50.0 ) ) );
				...
				float temp_output_10_0_g221 = break253.z;
				float lerpResult16_g221 = lerp( 0.0 , 1.0 , ( ( _DesertCoverage - ( break253.x * temp_output_10_0_g221 ) ) * _DesertFactors ));
				float4 lerpResult19_g221 = lerp( float4( ( _BaseColor * break253.x ).rgb , 0.0 ) , ( _DesertColor * temp_output_10_0_g221 ) , saturate( lerpResult16_g221 ));
				float lerpResult16_g220 = lerp( 0.0 , 1.0 , ( ( _MountainCoverage - break253.y ) * _MountainFactors ));
				float4 lerpResult19_g220 = lerp( float4( saturate( lerpResult19_g221 ).rgb , 0.0 ) , ( break253.x * _MountainColor ) , saturate( lerpResult16_g220 ));
				...
				float3 normalizeResult5_g218 = normalize( normalUnpacked30 );
				float dotResult14_g218 = dot( ase_tanViewDir , normalizeResult5_g218 );
				float4 _albedo535 = saturate( ( saturate( ( ( ( tex2D( _ScatterMap, ( ( _ScatterCenterShift + appendResult10_g225 ) * _ScatterStretch ) ) * _ScatterColor ) * _ScatterBoost ) + _ScatterIndirect ) ) * ( ( saturate( ( cloudMix80_g222 * _CloudsTint * _CloudsOutput ) ) * _CloudBoost ) + ( temp_output_500_122 * saturate( ( saturate( ( temp_output_277_0 * temp_output_277_0 * _AlbedoBoost ) ) + float4( ( ( saturate( pow( max( 0.0 , saturate( ( 1.0 - dotResult14_g218 ) ) ) , _FresnelPower ) ) * _FrenselMult ) * (_FresnelColor).rgb ) , 0.0 ) ) ) ) ) ) );
				
				float4 spec532 = ( break253.x * _Specular * _SpecularColor );
				
				float smoothness531 = ( _Smoothness * temp_output_500_122 );
				
				surfaceDescription.BaseColor = _albedo535.rgb;
				...
				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = spec532.rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = smoothness531;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 normalizeResult8_g224 = normalize( ase_worldViewDir );
				float dotResult7_g225 = dot( temp_output_1_0_g225 , normalizeResult8_g224 );
				float2 appendResult10_g225 = (float2(( ( dotResult4_g225 / 2.0 ) + 0.5 ) , dotResult7_g225));
				float time1_g223 = _TimeParameters.x;
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_500_122 = cloudMixShadow99_g222;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar17 = TriplanarSampling17( _DetailMap, packedInput.ase_texcoord9.xyz, packedInput.ase_normal, _TriplanarFalloff, _DetailTiling, 1.0, 0 );
				float4 detail41 = triplanar17;
				float4 break253 = detail41;
				float temp_output_10_0_g221 = break253.z;
				float lerpResult16_g221 = lerp( 0.0 , 1.0 , ( ( _DesertCoverage - ( break253.x * temp_output_10_0_g221 ) ) * _DesertFactors ));
				...
				float3 ase_tanViewDir =  tanToWorld0 * V.x + tanToWorld1 * V.y  + tanToWorld2 * V.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float4 triplanar5 = TriplanarSampling5( _NormalMap, packedInput.ase_texcoord9.xyz, packedInput.ase_normal, _TriplanarFalloff, _NormalTiling, 1.0, 0 );
				float3 unpack6 = UnpackNormalScale( triplanar5, _NormalScale );
				unpack6.z = lerp( 1, unpack6.z, saturate(_NormalScale) );
				float3 normalUnpacked30 = unpack6;
				float3 normalizeResult5_g218 = normalize( normalUnpacked30 );
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.RangedFloatNode;19;-613.5011,661.0359;Float;False;Property;_DetailTiling;Detail Tiling;11;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;526;3767.895,-944.1838;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;300;1824.06,-162.4667;Inherit;False;Fresnel;27;;218;f8c497a0c2d6d334f8e7138f24a77d5f;0;1;22;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-179.9657,277.7505;Float;False;Property;_NormalScale;Normal Scale;9;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;260;941.6013,-371.0421;Inherit;False;BaseColor;16;;219;436e5fd3b4e5f564d91908d8a8c53f20;0;1;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;368;1499.958,-172.1199;Float;False;Property;_AlbedoBoost;Albedo Boost;22;0;Create;True;0;0;0;False;0;False;0;20.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;277;1498.801,-295.5205;Inherit;False;MountainColor;23;;220;4181dbe52ccd82c468b472a633e7f96c;0;3;3;FLOAT;0;False;10;FLOAT;0;False;6;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;275;1208.695,-418.1058;Inherit;False;DesertColor;18;;221;1b595ba52fc886e48b4be4810312f928;0;3;3;FLOAT;0;False;10;FLOAT;0;False;6;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;520;-732.8716,-107.1458;Inherit;False;Property;_TriplanarFalloff;TriplanarFalloff;15;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-618.2471,270.9991;Float;False;Property;_NormalTiling;Normal Tiling;10;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;500;2210.691,-899.2236;Inherit;False;Clouds;31;;222;b41fa152b94c44b4e9f91f67316d221d;0;1;127;FLOAT4;0,0,0,0;False;3;FLOAT;122;FLOAT;137;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;372;2333.315,-347.239;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;522;3197.375,-943.6428;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;465;2632.212,-624.429;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;510;3363.679,-977.4264;Inherit;False;ScatterColor;0;;224;5984f944e2b849e44aad6ac4d7027dc1;0;1;31;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;525;3604.275,-801.9432;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;397;2167.925,-303.5969;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;496;2706.811,-787.9272;Float;False;Property;_CloudBoost;Cloud Boost;43;0;Create;True;0;0;0;False;0;False;5;11;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;83;2168.139,-56.13948;Float;False;Property;_Smoothness;Smoothness;14;0;Create;True;0;0;0;False;0;False;0;0.32;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;31;1450.068,-62.25322;Inherit;False;30;normalUnpacked;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;82;1080.414,47.00317;Float;False;Property;_Specular;Specular;13;0;Create;True;0;0;0;False;0;False;0;0.831;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;533;3961.146,-796.3641;Inherit;False;30;normalUnpacked;1;0;OBJECT;;False;1;FLOAT3;0
...
WireConnection;531;0;454;0
WireConnection;535;0;526;0
WireConnection;532;0;81;0
WireConnection;556;0;535;0
WireConnection;556;1;533;0
WireConnection;556;5;532;0
WireConnection;556;7;531;0
ASEEND*/
//CHKSM=2E8A5CE1E7F0EAC9B83FF80B9BD6424BBEF647A1