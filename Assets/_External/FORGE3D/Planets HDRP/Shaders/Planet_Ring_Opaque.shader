	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( tex2D( _DetailMap, appendResult18.xy ) * _RingTint ).rgb;
		...
		Pass
		{
            ...
            ColorMask [_DoubleSidedGIMode] 1
...
WireConnection;73;7;56;0
ASEEND*/
//CHKSM=22D26DDDC3BD4F8011B1DF7DC6753D7CD33DA338